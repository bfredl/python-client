...
class Host(object):
    ...
    def _wrap_delayed_function(self, cls, delayed_handlers, name, sync, module_handlers, path, *args):
    ...
    def _discover_functions(self, obj, handlers, plugin_path,delay):
        ...
        for _, fn in inspect.getmembers(obj, predicate):
            ...
            if delay:
                fn_wrapped = partial(self._wrap_delayed_function, obj, cls_handlers, method, sync,
